...
Partial Class Jigsaw_Puzzle_Game
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Jigsaw_Puzzle_Game))
        ...
        CType(Image6, ComponentModel.ISupportInitialize).BeginInit()
        CType(Image5, ComponentModel.ISupportInitialize).BeginInit()
        CType(Image4, ComponentModel.ISupportInitialize).BeginInit()
        ...
        Controls.Add(Image2)
        Controls.Add(Image1)
        Name = "Jigsaw_Puzzle_Game"
        Text = "Jigsaw_Puzzle_Game"
        CType(Image1, ComponentModel.ISupportInitialize).EndInit()
        CType(Image2, ComponentModel.ISupportInitialize).EndInit()
        CType(Image3, ComponentModel.ISupportInitialize).EndInit()
        CType(Image6, ComponentModel.ISupportInitialize).EndInit()
        CType(Image5, ComponentModel.ISupportInitialize).EndInit()
        CType(Image4, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents Image6 As PictureBox
    Friend WithEvents Image5 As PictureBox
